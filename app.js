...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_gsap_ScrollToPlugin__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_gsap_ScrollToPlugin___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_gsap_ScrollToPlugin__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__cards_panel__ = __webpack_require__(8);
...
var Tabs = (function(window, undefined) {
  ...
  function Tabs(id, el) {
    Array.prototype.forEach.call(tabsNav, function(nav){
      ...
      if (target) {
        var panel = new __WEBPACK_IMPORTED_MODULE_2__cards_panel__["a" /* default */](target);
        panels[target] = panel;
      }
      nav.onclick = _bindTab.bind(this, target, panels);
    });
    // todo onInit hideAllCards set Duration to 0
    document.querySelector('*[data-target="cardPanel3"]').click();
    // setTimeout( function(){
    // }, 1000);
    // the code
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Card__ = __webpack_require__(9);
...
var cardsPanel = (function(window, undefined) {
  ...
  function cardsPanel(cardSelector) {
    ...
    this.btn = new __WEBPACK_IMPORTED_MODULE_1__Button__["a" /* default */](this.btnTag);
    this.layout = {};
    polygonMap.points = [];
    var self = this;
    Array.prototype.forEach.call(this.elems, function(card, i){
      var instance = new __WEBPACK_IMPORTED_MODULE_0__Card__["a" /* default */](i, card);
...
/* harmony default export */ __webpack_exports__["a"] = (cardsPanel);
...
//    this._btns = this._el.querySelector(SELECTORS.btns);
    ...
    this.btn = new __WEBPACK_IMPORTED_MODULE_0__Button__["a" /* default */](this.btnTag);
  };
